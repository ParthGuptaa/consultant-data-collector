    ...
    <div style={{ fontFamily: "Arial", padding: "2rem", maxWidth: "900px", margin: "0 auto" }}>
      ...
      <div style={{ marginBottom: "1rem" }}>
        <input
          ...
          style={{ marginRight: "1rem", padding: "0.5rem", width: "320px" }}
        />
        <input
          type="text"
      ...
      <div style={{ marginBottom: "1.5rem" }}>
        <button onClick={runCollect} style={{ marginRight: "1rem", padding: "0.6rem 1.2rem" }}>
          {loading ? "Collecting..." : "Collect Data"}
        </button>
        <button onClick={handleExport} style={{ padding: "0.6rem 1.2rem" }}>
          Download Excel
        </button>
      </div>
